...
func runRepair(fs *fsckState, blockSize uint64, totalInodes int) error {
	...
	// 4. Stage summary values for superblock and checkpoint.
	...
	// 5. Write modified inodes back to the inode table.
	...
	// 7. Write superblock with corrected free counts.
	...
	// 8. Write fresh checkpoint block.
